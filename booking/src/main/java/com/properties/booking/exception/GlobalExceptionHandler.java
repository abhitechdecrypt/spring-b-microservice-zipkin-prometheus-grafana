...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<GlobalErrorResponse> handleBookingDataNotFoundException(BookingDataNotFoundException ex) {
    ...
    public ResponseEntity<GlobalErrorResponse> handleBookingAlreadyExistException(BookingAlreadyExistException ex) {
    	GlobalErrorResponse errorResponse = new GlobalErrorResponse(ex.getMessage(), ex.getErrorCode());
    	return new ResponseEntity<>(errorResponse, HttpStatus.NOT_FOUND);
    }
