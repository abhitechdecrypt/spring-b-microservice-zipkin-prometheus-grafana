...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<GlobalErrorResponse> handleOrderNotFound(PropertyDataNotFoundException ex) {
    ...
    public ResponseEntity<GlobalErrorResponse> handleOrderOutOfStock(NotAvailableException ex){
